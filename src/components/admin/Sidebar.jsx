      ...
      <div className="collapse navbar-collapse w-auto h-auto h-100 pb-5" id="sidenav-collapse-main">
        <ul className="navbar-nav">
          <li className="nav-item">
            <NavLink to={'/dashboard'} activeclassname={'active'} className="nav-link" aria-controls="dashboardsExamples" role="button" aria-expanded="false">
          ...
          <li className="nav-item">
            <NavLink to={'/properties'} activeclassname={'active'} className="nav-link " aria-controls="pagesExamples" role="button" aria-expanded="false">
              <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                    ...
                    <g transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF" fillRule="nonzero">
                      <g transform="translate(1716.000000, 291.000000)">
                        <g id="office" transform="translate(153.000000, 2.000000)">
                          <path className="color-background" d="M12.25,17.5 L8.75,17.5 L8.75,1.75 C8.75,0.78225 9.53225,0 10.5,0 L31.5,0 C32.46775,0 33.25,0.78225 33.25,1.75 L33.25,12.25 L29.75,12.25 L29.75,3.5 L12.25,3.5 L12.25,17.5 Z" opacity="0.6"></path>
          ...
          <li className="nav-item">
            <NavLink to={'/customers'} activeclassname={'active'} className="nav-link " aria-controls="authExamples" role="button" aria-expanded="false">
              <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
          ...
          <li className="nav-item">
            <NavLink to={'/negotiations'} activeclassname={'active'} className="nav-link " aria-controls="componentsExamples" role="button" aria-expanded="false">
              <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
              ...
              <span className="nav-link-text ms-1">Negotiations</span>
            </NavLink>
          </li>
          <li className="nav-item">
