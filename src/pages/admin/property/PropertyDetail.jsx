...
const PropertyDetail = () => {
  ...
  const deleteDataHandler = async () => {
    ...
    try {
      await deleteDoc(propertyDocRef).then(() => navigate('/properties'))
    } catch (err) {
      alert(err)
    }
  }
                ...
                <div className="card-body">
                  <div className="row">
                    ...
                    <div className="col-lg-6 mx-auto">
                      ...
                      <span className={(property.data.status === 'available' ? 'badge bg-gradient-success' : (property.data.status === 'unavailable' ? 'badge bg-gradient-danger' : 'badge bg-gradient-secondary'))}>{property.data.status}</span>
                      <br />
