          ...
          <div className='card mb-3'>
            <div class="row">
              <div class="col-4 pe-0">
                <div class="card blur shadow-blur max-height-vh-80 min-vh-80 overflow-auto overflow-x-hidden mb-5 mb-lg-0">
                  <div class="card-header shadow p-3">
                    <input type="email" class="form-control" placeholder="Search Customer" aria-label="Email" />
                  </div>
                  <div class="card-body p-2 overflow-auto overflow-x-hidden">
                    <Link to={'#'} class="d-block p-2 border-radius-lg bg-gradient-primary">
                      <div class="d-flex p-2">
                        <img alt="profile" src="/img/team-2.jpg" class="avatar shadow" />
                        <div class="ms-3">
                    ...
                    <Link to={'#'} class="d-block p-2">
                      <div class="d-flex p-2">
                        <img alt="profile" src="/img/team-1.jpg" class="avatar shadow" />
                        <div class="ms-3">
                    ...
                    <Link to={'#'} class="d-block p-2">
                      <div class="d-flex p-2">
                        <img alt="profile" src="/img/team-3.jpg" class="avatar shadow" />
                        <div class="ms-3">
                    ...
                    <Link to={'#'} class="d-block p-2">
                      <div class="d-flex p-2">
                        <img alt="profile" src="/img/team-5.jpg" class="avatar shadow" />
                        <div class="ms-3">
                    ...
                    <Link to={'#'} class="d-block p-2">
                      <div class="d-flex p-2">
                        <img alt="profile" src="/img/team-4.jpg" class="avatar shadow" />
                        <div class="ms-3">
                          <div class="justify-content-between align-items-center">
                    ...
                    <Link to={'#'} class="d-block p-2">
                      <div class="d-flex p-2">
                        <img alt="profile" src="/img/marie.jpg" class="avatar shadow" />
                        <div class="ms-3">
                          <div class="justify-content-between align-items-center">
                            <h6 class="mb-0">Ruby Arrayna</h6>
                            <p class="text-muted text-xs mb-2">2 day ago</p>
                          </div>
                          <span class="text-muted text-sm col-11 p-0 text-truncate d-block">It contains a lot of good lessons. Thanks</span>
                        </div>
                      </div>
                    </Link>
                  </div>
              ...
              <div class="col-8 ps-0">
                <div class="card blur shadow-blur max-height-vh-80 min-vh-80">
                  <div class="card-header shadow px-4" style={{ paddingTop: '0.7rem', paddingBottom: '0.7rem' }}>
                    <div class="row">
                      <div class="col-md-10">
                        <div class="d-flex align-items-center">
                          <img alt="profile" src="/img/team-2.jpg" class="avatar" />
                          <div class="ms-3">
                      ...
                      <div class="col-1 my-auto ps-0">
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end me-sm-n2 p-2" aria-labelledby="chatmsg">
                            ...
                            <li>
                              <Link to={'#'} class="dropdown-item border-radius-md text-danger">
                                Delete chat
                              </Link>
                            </li>
                          </ul>
                        ...
                        <div class="card ">
                          <div class="card-body p-2">
                            <div class="col-12 p-0">
                              <img src="https://images.unsplash.com/photo-1602142946018-34606aa83259?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1762&q=80" alt="Rounded" class="img-fluid mb-2 border-radius-lg" />
                            </div>
                            <div class="d-flex align-items-center text-sm opacity-6">
                              <i class="ni ni-check-bold text-sm me-1"></i>
                              <small>4:47pm</small>
