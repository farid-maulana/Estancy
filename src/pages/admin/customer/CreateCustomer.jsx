        ...
        <section className='mt-16 mb-16 w-full'>
          <div className='p-6'>
            <div className='bg-white rounded-lg p-6'>
              <h3 className='text-lg font-medium mb-1'>Add New Customer</h3>
              <p className='text-xs font-thin text-slate-400 mb-8'>Fill this form to register your new customer</p>
