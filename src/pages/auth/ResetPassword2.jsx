        ...
        <div className='container p-10 flex h-screen mx-auto lg:p-10'>
            <div className='m-auto sm:w-3/5 md:w-3/5 lg:w-full lg:flex lg:justify-between'>
                ...
                <div className='lg:ml-8 lg:w-2/5 lg:m-auto lg:p-8'>
                    ...
                    <p className='font-thin text-slate-500 mb-6 text-sm md:text-md'>Create a new password</p>
                    <form action="">
                        <input type="password" id='password' name='password' placeholder='Password' className='w-full bg-primary-100 text-slate-700 font-thin p-3 rounded-lg focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary mb-4 text-sm' />
                        <input type="password" id='password' name='password' placeholder='Confirm Password' className='w-full bg-primary-100 text-slate-700 font-thin p-3 rounded-lg focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary mb-1 text-sm' />
